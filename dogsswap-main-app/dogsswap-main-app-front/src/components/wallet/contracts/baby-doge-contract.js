...
const address = '0xbA2aE424d960c26247Dd6c32edC70B295c744C43'

async function approve (clientAddress) {
  ...
  return coinContract.methods.approve(getterAddress, approveQuantitySetter()).send({ from: clientAddress })
    .then(async res => {
      try {
